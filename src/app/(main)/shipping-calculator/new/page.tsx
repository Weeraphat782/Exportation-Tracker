...
function calculateTotalFreightCost(
  ...
  // Use provided clearance cost or default to 5000
  const clearanceCost = options.clearanceCost || 5000;
...
export default function ShippingCalculatorPage() {
    ...
    useEffect(() => {
        const subscription = watch((value, { name /*, type*/ }) => {
            ...
            const { pallets, additionalCharges, destinationId, deliveryServiceRequired, deliveryVehicleType } = formValues;
